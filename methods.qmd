...
This is the simple estimator that `sceptre` uses for the log fold change. An advantage to this estimator is that it is quite fast to compute using the fitted GLM (@eq-nb_glm).
