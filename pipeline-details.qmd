...
## Anatomy of a pipeline launch script
...
We conclude with a few common workflows in the context of the `sceptre` Nextflow pipeline.
...
This approach --- i.e., passing a set of candidate arguments to the pipeline, examining the output of the pipeline, and then updating the candidate arguments as necessary --- is generally useful strategy.
