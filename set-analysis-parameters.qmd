...
This chapter explicates the "set analysis parameters" step of the `sceptre` pipeline. The purpose of this step is to select the parameters that govern how the statistical analysis is to be carried out. The statistical procedures underlying `sceptre` are presented in @barry2021 and @barry2023.
