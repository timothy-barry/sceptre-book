...
None of these arguments is required, and all are set to sensible defaults. However, we recommend that users specify `discovery_pairs` and `positive_control_pairs` in most analyses. We describe these arguments below.
