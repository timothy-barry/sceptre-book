...
This step is optional; users instead can specify the analysis parameters on the command line as arguments to the Nextflow pipeline. **The Nextflow pipeline currently can handle about ~5 million pairs. Future iterations of the pipeline likely will be able to handle ~100 million pairs.**
