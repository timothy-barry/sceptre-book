...
## Addendum: installing Nextflow {#sec-install_nextflow}

Nextflow is a popular (and increasingly dominant) tool for orchestrating complex bioinformatic workflows. Users will need to install Nextflow on their local computer and cluster to use the `sceptre` Nextflow pipeline. The [Nextflow website](https://www.nextflow.io/docs/latest/index.html) contains extensive documentation, including instructions on downloading and installing Nextflow. Briefly, you can install Nextflow as follows.
