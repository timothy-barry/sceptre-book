...
For example, below, we create an `ondisc`-backed `sceptre_object` to represent the high-MOI CRISPRi data, setting `directory_to_write` to the temporary directory `tempdir()`.
