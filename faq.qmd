...
## How can I improve the speed of `sceptre`?
...
## `sceptre` unexpectedly crashed, or `sceptre` is using an unexpectedly large amount of memory or taking an unexpectedly long amount of time to run. What should I do?
