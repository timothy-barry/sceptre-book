...
Users should start by reading [The whole game](sceptre.qmd), which provides a high-level overview of `sceptre`. Users who wish to learn more about individual steps of the `sceptre` pipeline should read the subsequent chapters (i.e., *Import data* to *Run power check and discovery analysis*) in order. Finally, we recommend users consult the [Glossary](glossary.qmd) throughout to keep track of the terminology used in this book.
